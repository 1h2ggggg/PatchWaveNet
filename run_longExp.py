...
parser.add_argument('--S', type=int, default=512, help='')
parser.add_argument('--g_model', type=int, default=512, help='')
...
#PatchMixer
parser.add_argument('--mixer_kernel_size', type=int, default=8, help='kernel')
...
if args.is_training:
    for ii in range(args.itr):
        ...
        exp.train(setting)
        print('Train time: ', time.time() - time_1)
